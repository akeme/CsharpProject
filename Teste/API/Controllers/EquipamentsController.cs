...
namespace API.Controllers
{
    ...
    {
        private readonly EquipamentContext _context;

        public EquipamentsController(EquipamentContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Equipaments
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Equipament>>> GetEquipaments()
        {
        ...
        public async Task<ActionResult<Equipament>> PostEquipament(Equipament equipament)
        {
            ...
            return CreatedAtAction(nameof(GetEquipament), new { id = equipament.Id }, equipament);
        ...
        {
            return _context.Equipaments.Any(e => e.Id == id);
        }
    }
}
